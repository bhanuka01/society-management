...
# Application User & Administration Guide
...
## 8. Actuarial & Data Science Society (ADSS) Background & Official Info

### Overview & Basic Information
- **Society Name:** Actuarial & Data Science Society (ADSS)
- **University:** University of Ruhuna
- **Faculty:** Faculty of Science
- **Department:** Department of Mathematics
- **Established:** 2024
- **Membership:** 200+ undergraduate members across four FMIS batches
- **Primary Degree Program:** BSc (Hons) Financial Mathematics & Industrial Statistics (FMIS)
- **Official Website:** https://www.math.ruh.ac.lk/adss/
- **LinkedIn Page:** https://lk.linkedin.com/company/adssruhuna

### Mission & Vision
- **Mission:** Bridge the gap between university theory and industry practice, develop students' knowledge in actuarial & data science, provide career guidance, organize workshops & networking opportunities, and prepare students for professional careers in analytics, finance, insurance, and tech.
- **Vision:** Become a leading student organization promoting innovation in actuarial & data science, producing professionally competent graduates, and fostering leadership & collaboration.

### Core Focus Areas & Technical Domains
- Data Science, Artificial Intelligence (AI), Machine Learning (ML), Statistics, Financial Mathematics, Actuarial Science, Business Analytics, Cloud Computing, Python Programming, SQL & Databases, Power BI & Data Visualization, Capital Markets, Insurance Analytics, Blockchain & Web3, Career Development.

### Typical Society Activities
- **Technical Workshops:** Python, SQL, Power BI, Machine Learning, PySpark, Git & GitHub, Data Visualization.
- **Career Development:** CV Writing, LinkedIn Optimization, Interview Skills, Networking, Personal Branding.
- **Industry Sessions:** Insurance, Banking, Capital Markets, Data Analytics, AI, Financial Technology.
- **Academic & Community:** Research guidance, Mini symposiums, Guest lectures, Alumni talks, Charity initiatives, Student awareness programs.

### Notable Flagship Programs
- Data Science 360
- ProElevate
- GitHub & Open Source Projects
- PySpark & Machine Learning Bootcamp
- Insurance Career Insights
- LinkedIn Development & Professional Branding
- Alumni Insights
- Capital Markets & Acuity
- Chain Ceylon (Blockchain & Binance Academy collaboration)
- Mini Symposium
- Higher Studies Beyond Borders

### Supported Career Paths
- Data Scientist, Data Analyst, Machine Learning Engineer, Business Analyst, BI Developer, Actuary, Risk Analyst, Quantitative Analyst, Financial Analyst, Statistician, AI Engineer, Research Scientist.

---

*This guide contains full portal documentation and official ADSS society details for user support.*
